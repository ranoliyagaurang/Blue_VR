...
namespace VRFPSKit
{
    public class PhysicsButton : MonoBehaviour
    {
        ...
        {
            //distance from start / 
            float value = Vector3.Distance(_startPos + _joint.transform.TransformVector(_joint.axis) * _joint.linearLimit.limit, _joint.transform.position) / (_joint.linearLimit.limit);
