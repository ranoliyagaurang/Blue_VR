    ...
    public class MagazineEjectorInput : MonoBehaviour
    {
        ...
        void Update()
        {
            ...
            if (detachInput.WasReleasedThisFrame())
            {
                ...
                Invoke(nameof(ForceEjectMagazine), 2.5f);
            }
        ...
        private void ForceEjectMagazine()
        {
        ...
        public InputAction DetachInput()
        {
            ...
            //if (!_networkIdentity.isOwned) return null;
            //Make sure someone is holding the weapon
            //if (!_weaponInteractable.isSelected) return null;
            //Return if magazine interactor isn't holding a mag
            //if (_magazineInteractor.interactablesSelected.Count == 0) return null;
