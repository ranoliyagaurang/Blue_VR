...
namespace VRFPSKit
{
    ...
    public class SimpleMagazineInteractor : XRSocketInteractor
    {
        [Space]
        ...
        public void DetachMagazine()
        {
            ...
            tmpRB = interactablesSelected[0].transform.gameObject.GetComponent<Rigidbody>();
            Invoke(nameof(WaitMagazine), 0.25f);

            //Detach interactable
            interactionManager.CancelInteractorSelection((IXRSelectInteractor)this);
        }
        
        private void WaitMagazine()
        {
            if (tmpRB != null)
            {
