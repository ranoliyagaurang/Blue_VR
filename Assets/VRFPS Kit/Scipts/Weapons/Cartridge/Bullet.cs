...
namespace VRFPSKit
{
    ...
    public class Bullet : MonoBehaviour
    {
        ...
        public static Action<GameObject> EnemyDamage;
        ...
        private void OnCollisionEnter(Collision collision)
        {
            ...
            PlayImpactEffect(collision.GetContact(0).point, collision.GetContact(0).normal, collision.gameObject);
        ...
        private void PlayImpactEffect(Vector3 impactPoint, Vector3 impactNormal, GameObject hitObj)
        {
            hitSound.Play();
