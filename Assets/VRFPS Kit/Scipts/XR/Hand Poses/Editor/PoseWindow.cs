...
namespace VRFPSKit.HandPoses
{
    public class PoseWindow : EditorWindow
    {
        ...
        // Functionality
        private PoseEditorHandManager handManager = null;
        ...
        void CreatePoseHelper()
        {
            if (!poseHelper)
            {
                ...
                handManager = poseHelper.GetComponent<PoseEditorHandManager>();
            }
        }
        ...
        private void UpdateSelection()
        {
            ...
            SetHandActive(handManager.LeftHand, !_rightHand);
            SetHandActive(handManager.RightHand, _rightHand);
        }
